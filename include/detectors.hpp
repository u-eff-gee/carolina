        ...
        {
            {
                ...
                branches[3].second[0], [](const double uncalibrated_time){ return tdc_resolution*uncalibrated_time; }
            },
            {
                "E2",
                ...
                branches[3].second[1], [](const double uncalibrated_time){ return tdc_resolution*uncalibrated_time; }
            },
            {
                "E3",
                ...
                branches[3].second[2], [](const double uncalibrated_time){ return tdc_resolution*uncalibrated_time; }
            },
            {
                "E4",
        ...
        {
            {
                ...
                branches[3].second[4], [](const double uncalibrated_time){ return tdc_resolution*uncalibrated_time; }
            },
            {
                "E2",
                ...
                branches[3].second[5], [](const double uncalibrated_time){ return tdc_resolution*uncalibrated_time; }
            },
            {
                "E3",
                ...
                branches[3].second[6], [](const double uncalibrated_time){ return tdc_resolution*uncalibrated_time; }
            },
            {
                "E4",
        ...
        {
            {
                ...
                branches[3].second[8], [](const double uncalibrated_time){ return tdc_resolution*uncalibrated_time; }
            },
            {
                "E2",
                ...
                branches[3].second[9], [](const double uncalibrated_time){ return tdc_resolution*uncalibrated_time; }
            },
            {
                "E3",
                ...
                branches[3].second[10], [](const double uncalibrated_time){ return tdc_resolution*uncalibrated_time; }
            },
            {
                "E4",
        ...
        {
            {
                ...
                branches[3].second[12], [](const double uncalibrated_time){ return tdc_resolution*uncalibrated_time; }
            },
            {
                "E2",
                ...
                branches[3].second[13], [](const double uncalibrated_time){ return tdc_resolution*uncalibrated_time; }
            },
            {
                "E3",
                ...
                branches[3].second[14], [](const double uncalibrated_time){ return tdc_resolution*uncalibrated_time; }
            },
            {
                "E4",
        ...
        {
            {
                ...
                branches[4].second[0], [](const double uncalibrated_time){ return tdc_resolution*uncalibrated_time; }
            },
            {
                "E2",
                ...
                branches[4].second[1], [](const double uncalibrated_time){ return tdc_resolution*uncalibrated_time; }
            },
            {
                "E3",
                ...
                branches[4].second[2], [](const double uncalibrated_time){ return tdc_resolution*uncalibrated_time; }
            },
            {
                "E4",
        ...
        {
            {
                ...
                branches[4].second[4], [](const double uncalibrated_time){ return tdc_resolution*uncalibrated_time; }
            },
            {
                "E2",
                ...
                branches[4].second[5], [](const double uncalibrated_time){ return tdc_resolution*uncalibrated_time; }
            },
            {
                "E3",
                ...
                branches[4].second[6], [](const double uncalibrated_time){ return tdc_resolution*uncalibrated_time; }
            },
            {
                "E4",
        ...
        {
            {
                ...
                branches[4].second[8], [](const double uncalibrated_time){ return tdc_resolution*uncalibrated_time; }
            },
            {
                "E2",
                ...
                branches[4].second[9], [](const double uncalibrated_time){ return tdc_resolution*uncalibrated_time; }
            },
            {
                "E3",
                ...
                branches[4].second[10], [](const double uncalibrated_time){ return tdc_resolution*uncalibrated_time; }
            },
            {
                "E4",
        ...
        {
            {
                ...
                branches[4].second[12], [](const double uncalibrated_time){ return tdc_resolution*uncalibrated_time; }
            },
            {
                "E2",
                ...
                branches[4].second[13], [](const double uncalibrated_time){ return tdc_resolution*uncalibrated_time; }
            },
            {
                "E3",
                ...
                branches[4].second[14], [](const double uncalibrated_time){ return tdc_resolution*uncalibrated_time; }
            },
            {
                "E4",
